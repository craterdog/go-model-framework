...
[tickets](https://github.com/craterdog/go-model-framework/issues)
...
following:
 ...
 1. Make sure that all code changes and new code meet the coding conventions for
    the [class framework](https://github.com/craterdog/go-model-framework/wiki)
...
[discussion area](https://github.com/craterdog/go-model-framework/discussions)
for this project.
