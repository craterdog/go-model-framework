...
func (v *generator_) extractParameterAttributes(
	parameters col.ListLike[mod.ParameterLike],
	catalog col.CatalogLike[string, string],
) {
	var formatter = mod.Formatter().Make()
...
func (v *generator_) generateAttributeMethods(instance mod.InstanceLike) string {
	var formatter = mod.Formatter().Make()
	var methods string
...
func (v *generator_) generateClassAccess(class mod.ClassLike) string {
...
func (v *generator_) generateClassConstants(class mod.ClassLike) string {
	var formatter = mod.Formatter().Make()
...
func (v *generator_) generateClasses(directory string, model mod.ModelLike) {
...
func (v *generator_) generateClassMethods(class mod.ClassLike) string {
...
func (v *generator_) generateClassTarget(class mod.ClassLike) string {
...
func (v *generator_) generateConstantMethods(class mod.ClassLike) string {
	var formatter = mod.Formatter().Make()
	var methods string
	var classConstants = class.GetConstants()
	if classConstants == nil {
...
func (v *generator_) generateConstructorMethods(class mod.ClassLike) string {
	var formatter = mod.Formatter().Make()
	var methods string
...
func (v *generator_) generateFunctionMethods(class mod.ClassLike) string {
	var formatter = mod.Formatter().Make()
	var methods string
...
func (v *generator_) generateHeader(model mod.ModelLike) string {
...
func (v *generator_) generateImports(model mod.ModelLike, class string) string {
	var modules string
...
func (v *generator_) generatePublicMethods(instance mod.InstanceLike) string {
	var formatter = mod.Formatter().Make()
...
func (v *generator_) parseModel(directory string) mod.ModelLike {
	var modelFile = directory + "Package.go"
...
func (v *generator_) replaceGenericType(
	genericTypes col.ListLike[mod.ParameterLike],
	concreteTypes col.ListLike[mod.AbstractionLike],
	abstraction mod.AbstractionLike,
) mod.AbstractionLike {
	var formatter = mod.Formatter().Make()
	var prefix = abstraction.GetPrefix()
	...
	if arguments != nil {
		...
		arguments = col.List[mod.AbstractionLike]().Make()
	...
	abstraction = mod.Abstraction().MakeWithAttributes(prefix, identifier, arguments)
	return abstraction
}
...
func (v *generator_) replaceParameterTypes(
	genericTypes col.ListLike[mod.ParameterLike],
	concreteTypes col.ListLike[mod.AbstractionLike],
	methodParameters col.ListLike[mod.ParameterLike],
) col.ListLike[mod.ParameterLike] {
	var parameterIterator = methodParameters.GetIterator()
	methodParameters = col.List[mod.ParameterLike]().Make()
	for parameterIterator.HasNext() {
		...
		methodParameter = mod.Parameter().MakeWithAttributes(parameterName, parameterType)
...
func (v *generator_) replaceResultTypes(
	...
	if resultAbstraction != nil {
		...
		methodResult = mod.Result().MakeWithAbstraction(resultAbstraction)
	} else {
		...
		methodResult = mod.Result().MakeWithParameters(resultParameters)
	}
	return methodResult
}
